...
public class Swap
{
    ...
    public static class AnimationReplacement implements Comparable<AnimationReplacement> {
        ...
        public int auto = -1; // -1 indicates that this animationreplacement was not autogenerated. other values indicate the itemId that was added as a model swap to generate this.
