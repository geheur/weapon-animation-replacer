...
public class MigrationTest
{
	...
	public void testRenameAnimationSet() {
		...
		String config = plugin.getGson().toJson(Collections.singletonList(new TransmogSet(Collections.singletonList(new Swap(Collections.emptyList(), Collections.emptyList(), Collections.singletonList(new Swap.AnimationReplacement(new AnimationSet("Godsword", false, new int[Swap.AnimationType.values().length], false), Swap.AnimationType.ALL, null)), Collections.emptyList(), Collections.emptyList(), Collections.emptyList())))));
